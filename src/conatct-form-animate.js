...
var cfsuccessmsg = `<h3 class="title">Message Sent</h3><p>Your message has been successfully sent, I will contact with you soon. 🍻</p>`;
...
window.onload = () => {
    ...
    cfstylesheet.href =
        "https://cdn.jsdelivr.net/gh/cachecleanerjeet/contact-form@master/src/style-animate.min.css";
